...
#ifndef _OSHLAB_ILI9341H_
#define _OSHLAB_ILI9341H_
...
class OSHLAB_ILI9341 : public Adafruit_GFX {

 public:

  OSHLAB_ILI9341(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK,
		   int8_t _RST, int8_t _MISO);
  OSHLAB_ILI9341(int8_t _CS, int8_t _DC, int8_t _RST = -1);
